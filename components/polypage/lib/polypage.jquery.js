...
(function($) {
  ...
  $.fn.polypage = function(opts) {
    ...
    for(var i in $.polypage.extensionList) {
      ...
      if(this['role'+extension]) this['role'+extension](opts[extension.toLowerCase()] || {});
    }
    return this
  };
  ...
  $.polypage.Base.prototype = {
    ...
    setStartStates: function(){
      ...
      for(var i in this.options.defaultStates) { this.setState(this.options.defaultStates[i], true); }
  ...
  $.polypage.extension = function(__extensionName__, __defaults__, __prototype__) {
    ...
    $.fn['role'+__extensionName__] = function(opts) {
      return this.each(function() {
        (opts = opts || {}).bindTo = opts.bindTo || this;
        $(this).data('role'+__extensionName__, new $.polypage[__extensionName__](this, opts)); 
      });
    };
